...
Proficient developers who understand programming language fundamentals and need Go's specific syntax, choices, and idioms. Fast.

**Why this tutorial exists**

This tutorial grew out of frustration with some of the Go material available to experienced developers. The books I read felt either outdated or too unfocused for someone who already knows how to program: examples were often long, hard to scan, and scattered across many pages, and the progression sometimes emphasized edge cases over building a clear mental model of the language.
